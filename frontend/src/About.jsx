            ...
            <div>
                <div className="flex items-center justify-center h-screen">
                    <div className="text-center">
                        ...
                        <h1 className="text-4xl dark:text-white font-bold">Acerca de <span className="text-blue-500">U</span>Social</h1>
                        <p className="text-center text-3xl m-10 dark:text-white">
                            <span className="text-blue-500">U</span>Social es una red social creada para la comunidad universitaria de la Universidad de San Carlos de Guatemala. Conéctate con tus compañeros y profesores, comparte tus ideas y proyectos, y mantente al tanto de las últimas noticias y eventos de la universidad. ¡Únete a <span className="text-blue-500">U</span>Social hoy mismo!
                        </p>
